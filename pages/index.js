...
export default function Home () {
  ...
  const predictImage = () => {
    ...
    const randomPrediction = predictions[Math.floor(
      Math.random() * predictions.length)];
    setImagePrediction(
      `Hasil analisis menunjukkan kemungkinan: ${ randomPrediction }`);
  };
      ...
      <main className="main">
          ...
          <div className="container position-relative">
            <div className="row gy-5">
              <div
                ...
                <h2>Crop-Care</h2>
                <p>An AI-based plant disease detection application that helps
                  farmers identify diseases quickly and accurately through leaf
                  images, supporting early prevention and increasing crop
                  yields.</p>
              </div>
              ...
              <div className="row gy-4 mt-3"
                ...
                { showVideo && (
                  <>
                    <video ref={ videoRef } width="100%" height="300" autoPlay
                           playsInline
                           style={ { border: '2px solid #ccc' } }></video>
                    <button onClick={ stopScan }
                            style={ { display: 'block' } }>Close Camera
                    </button>
                    <button onClick={ predictDisease }
                            style={ { display: 'block' } }>Prediksi
                    </button>
                  </>
                ) }
                ...
                { prediction && (
                  <div id="predictionResult"
                       style={ { marginTop: '20px', border: '2px solid #4CAF50', padding: '10px', backgroundColor: '#e8f5e9' } }>
                    <h4>Hasil Prediksi:</h4>
                    <p>{ prediction }</p>
                    <span onClick={ closePredictionResult }
                          style={ { position: 'absolute', top: '10px', right: '10px', cursor: 'pointer' } }>
                      <i className="bi bi-x-circle"
                         style={ { fontSize: '24px', color: '#ff0000' } }></i>
                    </span>
                  </div>
                ) }
                ...
                <div className="col-xl-3 col-md-6">
                  <div className="icon-box">
                    <div className="icon"><i className="bi bi-card-image"></i>
                    </div>
                    <h4 className="title">
                ...
                { imagePreview && (
                  <div id="imageContainer"
                       style={ { display: 'block', position: 'relative', maxWidth: '100%', marginTop: '20px', border: '2px solid #ccc' } }>
                ...
                <button onClick={ predictImage } style={ {
                ...
                { imagePrediction && (
                  <div id="imagePredictionResult"
                       style={ { marginTop: '20px', border: '2px solid #4CAF50', padding: '10px', backgroundColor: '#e8f5e9' } }>
                    <h4>Hasil Prediksi:</h4>
                    <p>{ imagePrediction }</p>
                    <span onClick={ closeImagePredictionResult }
                          style={ { position: 'absolute', top: '10px', right: '10px', cursor: 'pointer' } }>
                      <i className="bi bi-x-circle"
                         style={ { fontSize: '24px', color: '#ff0000' } }></i>
                    </span>
        ...
        <section id="features" className="features section light-background">
          ...
          <div className="container section-title" data-aos="fade-up">
            <h2>Features</h2>
            <div><span>Check Our</span> <span
              className="description-title">Features</span></div>
          </div>
          {/* End Section Title */ }
          <div className="container">
            <div className="row gy-5 justify-content-between">
              <div className="col-xl-5" data-aos="zoom-out"
                   data-aos-delay={ 100 }>
                <img src="assets/user/img/features.png" className="img-fluid"
                     alt/>
              </div>
            ...
            <div className="row gy-4">
              <div className="col-lg-4" data-aos="fade-up"
                ...
                <div className="content px-xl-5">
                  <h3><span>Frequently Asked </span><strong>What is the
                    relationship between cassava and corn in
                    agriculture?</strong></h3>
                  <p>
                    Cassava and corn are often planted together in an
                    intercropping system. Corn helps provide shade for cassava
                    in the early stages of growth, while cassava can still grow
                    well despite having a longer harvest cycle.
                  </p>
                </div>
              </div>
              <div className="col-lg-8" data-aos="fade-up"
                ...
                <div className="faq-container">
                  <div className="faq-item faq-active">
                    <h3><span className="num">1.</span> <span>What type of soil is suitable for planting cassava and corn?</span>
                    </h3>
                    <div className="faq-content">
                      <p>These two plants are suitable for planting in loose
                        soil, on the outskirts of the city, and have good
                        drainage to prevent waterlogging.</p>
                    </div>
                    <i className="faq-toggle bi bi-chevron-right"/>
                  </div>
                  {/* End Faq item*/ }
                  <div className="faq-item faq-active">
                    <h3><span className="num">2.</span> <span>How to deal with pests that attack corn and cassava?</span>
                    </h3>
                    <div className="faq-content">
                      <p>Use organic or chemical pesticides as needed. Cassava
                        is often affected by mites, while corn is susceptible to
                        armyworms.</p>
                    </div>
                    <i className="faq-toggle bi bi-chevron-right"/>
                  </div>
                  {/* End Faq item*/ }
                  <div className="faq-item faq-active">
                    <h3><span className="num">3.</span> <span> Can cassava and corn be planted together?</span>
                    </h3>
                    <div className="faq-content">
                      <p>Yes, both can be planted together using the
                        intercropping method, as long as the planting distance
                        is arranged so that they do not compete with each
                        other.</p>
                    </div>
                    <i className="faq-toggle bi bi-chevron-right"/>
                  </div>
                  {/* End Faq item*/ }
                  <div className="faq-item faq-active">
                    <h3><span className="num">4.</span> <span>How long does it take to harvest?</span>
                    </h3>
                    <div className="faq-content">
                      <p>Cassava is usually harvested in 9-12 months, while corn
                        can be harvested in 3-4 months.</p>
                    </div>
                    <i className="faq-toggle bi bi-chevron-right"/>
                  </div>
                  {/* End Faq item*/ }
                  <div className="faq-item faq-active">
                    <h3><span className="num">5.</span> <span>What is the best fertilizer for cassava and corn?</span>
                    </h3>
                    <div className="faq-content">
                      <p>Compost or manure is very good for growth, combined
                        with NPK fertilizer for maximum results.</p>
                    </div>
                    <i className="faq-toggle bi bi-chevron-right"/>
                  </div>
                  {/* End Faq item*/ }
